			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="secondName" title="${message(code: 'person.secondName.label', default: 'Second Name')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personInstance, field: "secondName")}</td>
