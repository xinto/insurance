			...
			<table>
				...
				<g:each in="${carModelInstanceList}" status="i" var="carModelInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${carModelInstance.id}">${fieldValue(bean: carModelInstance, field: "name")}</g:link></td>
					
						<td>${fieldValue(bean: carModelInstance, field: "carBrand")}</td>
