			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="type" title="${message(code: 'productType.type.label', default: 'Type')}" />
				...
				<g:each in="${productTypeInstanceList}" status="i" var="productTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${productTypeInstance.id}">${fieldValue(bean: productTypeInstance, field: "type")}</g:link></td>
