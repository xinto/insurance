...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col_1">
                <div class="header">
                <h2>Solicitud de seguro de Gastos Médicos Mayores Individual o Familiar</h2>
                </div>
            </div>
        </div>
    <form class="form-horizontal">
        <div class="row">
            ...
            <div class="control-group">
              <label class="control-label" for="application-date">Fecha de Solicitud</label>
              <div class="controls">
      ...
      <div class="row">           
        ...
        <div class="col_6">          
                <input id="detail" name="detail" type="text" placeholder="Detalle" >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col_4">
          <div class="control-group">
            <label class="control-label" for="sum-insured">Suma Asegurada</label>
            <div class="controls">
      ...
      <div class="row">
        <div class="col_1">
          <h4>II.-Datos Personales del Solicitante</h4>
             ...
             <tr>
                  <td>
              <input id="birth_date" name="birth_date" type="text" placeholder="Fecha de Nacimiento" class="datepicker">
                  </td>
                  <td>
              ...
              <input id="occupation" name="occupation" type="text" placeholder="Ocupación o Profesión">
                  ...
                  <td>
              <input id="birth_place" name="birth_place" type="text" placeholder="Lugar de Nacimiento">
                  </td>
                  <td>
              ...
              <input id="rfc" name="rfc" type="text" placeholder="RFC o CURP">
                ...
                <tr>
                  <td colspan="2">
              <input id="name-representant" name="name-representant" type="text" placeholder="Nombre del Representante de Seguros Monterrey">
                  </td>
                  <td colspan="2">
