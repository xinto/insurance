...
<html>
	...
	<body>
		<a href="#edit-contractor" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-contractor" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${contractorInstance?.version}" />
				<fieldset class="form">
