	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<g:if test="${productInstance?.productsProductTypes}">
				<li class="fieldcontain">
					<span id="productsProductTypes-label" class="property-label"><g:message code="product.productsProductTypes.label" default="Products Product Types" /></span>
